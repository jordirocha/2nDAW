...
public class Main {
    ...
    private void run() {
        ...
        do {
            ...
            switch (choice) {  //new switch: returns a value.
                case 0 ->
                    exitApp();  //break clause not required.
                case 1 ->
                    displayArticlesToBuy();
                case 2 ->
                    displayBoughtArticles();
                case 3 ->
                    addToList();
                case 4 ->
                    buy();
    ...
    /**
     * asks the user to input the article to add, verifies that the article does
     * not exist in any list and adds it to list, and reports result to user
     */
    ...
    /**
     * displays the list of articles to buy, asks the user to select an article.
     * I correctly selected, searches the article in the list of articles to
     * buy, asks the user to input the price, moves an article from the list of
     * articles to buy to the list of bought articles and reports result to
     * user. If not, reports error to user.
     */
    private void buy() {
    ...
    /**
     * asks the user to input the text of the article to remove, searches the
     * article in the list and, if found, shows the article and asks for
     * confirmation. If not found, reports error to user. Then removes the
     * article from the list of articles to buy, and reports result to user
     */
